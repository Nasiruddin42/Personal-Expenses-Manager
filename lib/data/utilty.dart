...
String formatCurrency(int value) {
  final format = NumberFormat.currency(
    ...
    decimalDigits: 0, // Number of decimal digits (set to 0 for BD)
    locale: 'en_US', // US locale for formatting
  );

  return '${format.format(value)}TAKA'; // Append ' vnđ' to the formatted value
}
